  ...
  const renderDependencyModal = () => {
    ...
    return createPortal(
      <div className="fixed inset-0 z-[1050] flex items-center justify-center p-4">
        ...
        />
        <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 max-w-md w-full animate-fade-in">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
            Add Dependency
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Create a dependency from <span className="font-medium text-gray-900 dark:text-white">{fromTask?.name}</span> to <span className="font-medium text-gray-900 dark:text-white">{toTask?.name}</span>
          </p>
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-white">Dependency Graph</h3>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Icon icon="solar:minus-circle-linear" className="w-5 h-5 text-gray-600 dark:text-gray-400" />
          </button>
          ...
          <button
            ...
            className="p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
          >
            <Icon icon="solar:add-circle-linear" className="w-5 h-5 text-gray-600 dark:text-gray-400" />
          </button>
          ...
          <button
            ...
            className="p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
          >
            <Icon icon="solar:restart-linear" className="w-5 h-5 text-gray-600 dark:text-gray-400" />
          </button>
        </div>
      </div>
          ...
          >
            ...
            <defs>
              <pattern id="grid" width="20" height="20" patternUnits="userSpaceOnUse">
                <circle cx="1" cy="1" r="1" fill="currentColor" className="text-gray-200 dark:text-gray-700" />
              </pattern>
            </defs>
            <rect
              x={viewBox.x - 1000}
      ...
      <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/30">
        <div className="flex items-center gap-4">
          <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Dependency Types:</span>
