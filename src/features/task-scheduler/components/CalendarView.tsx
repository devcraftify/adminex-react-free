      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            >
              <Icon icon="solar:alt-arrow-left-linear" className="w-5 h-5 text-gray-600 dark:text-gray-400" />
            </button>
            <button
              onClick={navigateNext}
              className="p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
            >
              <Icon icon="solar:alt-arrow-right-linear" className="w-5 h-5 text-gray-600 dark:text-gray-400" />
            </button>
          </div>
      ...
      <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/30">
        <div className="flex items-center gap-4">
          <span className="text-sm text-gray-600 dark:text-gray-400">
            <span className="font-medium text-gray-900 dark:text-white">{tasks.length}</span> total tasks
          </span>
          <span className="text-sm text-gray-600 dark:text-gray-400">
