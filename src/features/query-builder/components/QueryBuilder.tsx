...
export function QueryBuilder({ query: initialQuery, onChange, onExecute, showPreview = true }: QueryBuilderProps) {
  ...
  return (
    <div className="bg-white dark:bg-surface-900 rounded-2xl shadow-lg border border-surface-200 dark:border-surface-700 overflow-hidden">
      {/* Header */}
      <div className="px-6 py-5 bg-gradient-to-r from-accent-500 to-primary-500">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {queryPresets.map((preset) => (
              <button
                ...
                className="flex items-start gap-3 p-3 bg-white dark:bg-surface-800 rounded-xl border border-surface-200 dark:border-surface-700 hover:border-accent-300 dark:hover:border-accent-600 hover:shadow-md transition-all text-left group"
              >
...
function FilterRow({ filter, fieldsByCategory, onChange, onRemove }: FilterRowProps) {
  ...
  return (
    <div className="flex items-start gap-3 p-3 bg-white dark:bg-surface-800 rounded-lg border border-surface-200 dark:border-surface-700 shadow-sm group hover:shadow-md transition-shadow">
      {/* Field Selector */}
