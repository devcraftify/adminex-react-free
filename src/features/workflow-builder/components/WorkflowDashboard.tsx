...
export function WorkflowDashboard() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-180px)] bg-surface-100 dark:bg-surface-800 rounded-2xl overflow-hidden shadow-lg border border-surface-200 dark:border-surface-700">
      {/* Toolbar */}
