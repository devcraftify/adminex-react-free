...
const ApprovalEnginePage = lazy(() => import('@/pages/features').then(m => ({ default: m.ApprovalEnginePage })))
const TaskSchedulerPage = lazy(() => import('@/pages/features').then(m => ({ default: m.TaskSchedulerPage })))
const NotificationPipelinePage = lazy(() => import('@/pages/features').then(m => ({ default: m.NotificationPipelinePage })))
    ...
    children: [
      ...
      // ============================
      {
        ...
        children: [
          ...
          {
            path: 'features/approval-engine',
            element: withSuspense(ApprovalEnginePage),
          },
          {
          ...
          {
            path: 'features/notification-pipeline',
            element: withSuspense(NotificationPipelinePage),
          },
        ],
      },
    ],
