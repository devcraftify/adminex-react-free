      ...
      <aside className={`layout-sidebar bg-white dark:bg-surface-900 border-surface-200 dark:border-surface-800 flex transition-all duration-300 ${
        ...
        {!isHorizontal && (
          <div className="p-4 border-t border-surface-200 dark:border-surface-800">
            <Link
              to="/auth/login"
              className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-secondary-600 dark:text-secondary-400 hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors"
            >
