    ...
    <section id="demos" className="py-24 px-4 bg-surface-50 dark:bg-surface-950 scroll-mt-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-end justify-between gap-6 flex-wrap mb-16">
          ...
          <Link to="/dashboard" className="px-6 py-3 rounded-xl bg-white dark:bg-surface-800 border border-surface-200 dark:border-surface-700 text-secondary-900 dark:text-white font-semibold shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5 flex items-center gap-2">
