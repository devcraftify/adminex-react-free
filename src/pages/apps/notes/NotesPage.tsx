  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="heading-2 text-secondary-900 dark:text-white">{t('notes.title')}</h1>
          <p className="text-body-sm text-secondary-500 dark:text-secondary-400 mt-1">
            {t('notes.count', { count: sortedNotes.length })}
          </p>
        </div>
        <button
          onClick={handleAddNew}
          className="flex items-center gap-2 px-4 py-2.5 bg-theme-primary text-white rounded-xl hover:bg-theme-primary-dark transition-colors font-medium"
        >
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-xl text-sm text-secondary-900 dark:text-white placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary transition-all"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {sortedNotes.map((note) => {
            ...
            return (
              <div
                key={note.id}
                className={`${colorClasses.bg} border ${colorClasses.border} rounded-xl p-5 hover:shadow-lg transition-shadow group relative flex flex-col`}
              >
                {/* Category Badge */}
                <div className="mb-3">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-1.5">
                    {t('notes.note_title')} <span className="text-danger-500">*</span>
                  </label>
                  <input
                    type="text"
                  ...
                  />
                  {formErrors.title && (
                    <p className="mt-1 text-xs text-danger-500">{formErrors.title}</p>
                  )}
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-1.5">
                    {t('notes.content')} <span className="text-danger-500">*</span>
                  </label>
                  <textarea
                  ...
                  />
                  {formErrors.content && (
                    <p className="mt-1 text-xs text-danger-500">{formErrors.content}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-secondary-400">{t('common.separate_with_commas')}</p>
                </div>
