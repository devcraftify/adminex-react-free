...
export function BlogDetailPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <button
        onClick={() => navigate('/app/blog')}
        className="flex items-center gap-2 text-secondary-600 dark:text-secondary-400 hover:text-theme-primary transition-colors"
      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {prevPost && (
              <button
                ...
                className="card rounded-xl p-4 text-left group hover:shadow-lg transition-all"
              >
            ...
            {nextPost && (
              <button
                ...
                className="card rounded-xl p-4 text-right group hover:shadow-lg transition-all sm:col-start-2"
              >
          ...
          <div className="card rounded-xl p-6">
            ...
            <form onSubmit={handleCommentSubmit} className="mb-6">
              ...
              <div className="flex justify-end mt-3">
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-theme-primary text-white rounded-xl text-sm font-medium hover:opacity-90 transition-opacity"
                >
                  {t('blog.post_comment')}
                </button>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="card rounded-xl p-6">
            <div className="text-center">
              ...
              <button className="w-full px-4 py-2.5 bg-theme-primary text-white rounded-xl text-sm font-medium hover:opacity-90 transition-opacity">
