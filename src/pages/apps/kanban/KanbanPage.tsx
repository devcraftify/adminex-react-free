            ...
            <div className="flex flex-col w-80 flex-shrink-0">
              <div className="bg-surface-100 dark:bg-surface-800 rounded-xl p-3">
                <input
                  ...
                  autoFocus
                  className="w-full px-3 py-2 bg-white dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-lg text-sm text-secondary-900 dark:text-white placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary mb-2"
                />
                <div className="flex items-center gap-2">
                  <button
                    onClick={handleAddColumn}
                    className="px-3 py-1.5 bg-theme-primary hover:bg-theme-primary-dark text-white text-sm rounded-lg font-medium transition-colors"
                  >
                    {t('kanban.add_column')}
                  </button>
                  <button
                    ...
                    className="p-1.5 hover:bg-surface-200 dark:hover:bg-surface-700 rounded text-secondary-500 transition-colors"
                  >
