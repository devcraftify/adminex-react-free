...
export default function KanbanCard({ task, onClick }: KanbanCardProps) {
  ...
  return (
    <div
      ...
      {...listeners}
      onClick={onClick}
      className="relative group bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg p-3 hover:shadow-lg transition-all hover:border-surface-300 dark:hover:border-surface-600"
    >
      {/* Priority */}
