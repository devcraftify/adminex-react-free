    ...
    <div className="h-[calc(100vh-112px)] flex animate-fade-in card rounded-xl overflow-hidden">
      ...
      <div className="hidden md:flex w-56 lg:w-60 shrink-0 bg-white dark:bg-surface-900 border-e border-surface-200 dark:border-surface-700 flex-col overflow-hidden">
        ...
        <div className="p-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-theme-primary text-white rounded-xl text-label hover:opacity-90 transition-opacity"
          >
      ...
      <div className={`w-full md:w-80 lg:w-96 shrink-0 flex flex-col bg-white dark:bg-surface-900 ${selectedEmail ? 'hidden md:flex' : 'flex'} border-e border-surface-200 dark:border-surface-700`}>
        ...
        <div className="h-14 px-4 flex items-center justify-between border-b border-surface-200 dark:border-surface-700">
          ...
          <div className="relative flex-1 max-w-md ms-4">
            <Icon icon={Icons.search} className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-secondary-400" width={16} height={16} />
            <input
              type="text"
              placeholder={t('apps.email.search_placeholder')}
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full ps-10 pe-4 py-2 bg-surface-50 dark:bg-surface-800 border-0 rounded-lg text-body-sm text-secondary-900 dark:text-white placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-theme-primary/20"
            />
          </div>
        </div>
      ...
      {selectedEmail ? (
        <div className="flex-1 min-w-0 flex flex-col bg-white dark:bg-surface-900 overflow-hidden">
          ...
          <div className="p-4 border-t border-surface-200 dark:border-surface-700">
            <div className="flex items-center gap-2">
              <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-theme-primary text-white rounded-xl text-label hover:opacity-90 transition-opacity">
                <Icon icon={Icons.arrowLeft} className="w-4 h-4" width={16} height={16} />
                {t('apps.email.reply')}
              </button>
              <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-surface-100 dark:bg-surface-800 text-secondary-700 dark:text-secondary-300 rounded-xl text-label hover:bg-surface-200 dark:hover:bg-surface-700 transition-colors">
          ...
          <div className="relative w-full sm:w-full sm:max-w-2xl bg-white dark:bg-surface-900 rounded-t-2xl sm:rounded-2xl shadow-2xl animate-fade-in overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center gap-3 pb-3 border-b border-surface-200 dark:border-surface-700">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent border-0 text-body-sm text-secondary-900 dark:text-white placeholder-secondary-400 focus:outline-none"
                />
              </div>
              ...
              <textarea
                ...
                className="w-full bg-transparent border-0 text-body-sm text-secondary-900 dark:text-white placeholder-secondary-400 focus:outline-none resize-none"
              />
            </div>
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-surface-50 dark:bg-surface-800 border-t border-surface-200 dark:border-surface-700">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => setIsComposeOpen(false)}
                  className="px-4 py-2 text-label text-secondary-600 dark:text-secondary-400 hover:bg-surface-200 dark:hover:bg-surface-700 rounded-lg transition-colors"
                >
                  {t('apps.email.discard')}
                </button>
                <button className="flex items-center gap-2 px-4 py-2 bg-theme-primary text-white rounded-lg text-label hover:opacity-90 transition-opacity">
