          ...
          <div className="card rounded-xl p-12 text-center">
            ...
            <div className="space-y-3">
              <Link
                ...
                className="block w-full px-6 py-3 bg-theme-primary text-white rounded-lg hover:bg-theme-primary-dark transition-colors font-medium"
              >
                {t('ecommerce.continue_shopping')}
              </Link>
              <button
                onClick={() => navigate('/dashboard')}
                className="block w-full px-6 py-3 bg-surface-100 dark:bg-surface-800 text-secondary-900 dark:text-white rounded-lg hover:bg-surface-200 dark:hover:bg-surface-700 transition-colors font-medium"
              >
    ...
    <div>
      ...
      {cartItems.length === 0 ? (
        <div className="card rounded-xl p-12 text-center">
          ...
          <Link
            to="/app/ecommerce/products"
            className="inline-flex px-6 py-3 bg-theme-primary text-white rounded-lg hover:bg-theme-primary-dark transition-colors font-medium"
          >
            {t('ecommerce.browse_products')}
          </Link>
        </div>
      ) : step === 'cart' ? (
                    ...
                    <div className="flex flex-col items-end justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="p-1 hover:bg-surface-100 dark:hover:bg-surface-800 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
          ...
          <div className="lg:col-span-1">
            <div className="card rounded-xl p-6 sticky top-6">
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-theme-primary text-white rounded-lg hover:bg-theme-primary-dark transition-colors font-medium"
              >
                {t('ecommerce.proceed_checkout')}
              </button>
              <Link
                to="/app/ecommerce/products"
                className="block w-full px-6 py-3 text-center bg-surface-100 dark:bg-surface-800 text-secondary-900 dark:text-white rounded-lg hover:bg-surface-200 dark:hover:bg-surface-700 transition-colors font-medium mt-3"
              >
                {t('ecommerce.continue_shopping')}
              </Link>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="card rounded-xl p-6">
                ...
                <div className="flex items-center gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  <Icon icon={Icons.lock} width={16} height={16} className="text-blue-600 dark:text-blue-400" />
            ...
            <div className="lg:col-span-1">
              <div className="card rounded-xl p-6 sticky top-6">
                ...
                <button
                  ...
                  className="w-full px-6 py-3 text-center bg-surface-100 dark:bg-surface-800 text-secondary-900 dark:text-white rounded-lg hover:bg-surface-200 dark:hover:bg-surface-700 transition-colors font-medium mt-3"
                >
