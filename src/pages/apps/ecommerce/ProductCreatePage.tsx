        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={4}
                    className={`w-full px-4 py-2.5 bg-surface-50 dark:bg-surface-800 border rounded-xl text-sm text-secondary-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary transition-all resize-none ${
                      errors.description
                        ? 'border-danger-500'
                        : 'border-surface-200 dark:border-surface-700'
                    }`}
                  ...
                  />
                  {errors.description && (
                    <p className="mt-1 text-xs text-danger-500">{errors.description}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    />
                    {errors.sku && (
                      <p className="mt-1 text-xs text-danger-500">{errors.sku}</p>
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="card rounded-xl p-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      step="0.01"
                      min="0"
                      className={`w-full pl-7 pr-4 py-2.5 bg-surface-50 dark:bg-surface-800 border rounded-xl text-sm text-secondary-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary transition-all ${
                        errors.price
                          ? 'border-danger-500'
                          : 'border-surface-200 dark:border-surface-700'
                      }`}
                  ...
                  {errors.price && (
                    <p className="mt-1 text-xs text-danger-500">{errors.price}</p>
                  )}
                </div>

                <div>
                  <label className="block text-sm font-medium text-secondary-700 dark:text-secondary-300 mb-2">
                    {t('ecommerce.original_price')}
                  </label>
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-secondary-500">
                      $
                    ...
                    <input
                      ...
                      step="0.01"
                      min="0"
                      className="w-full pl-7 pr-4 py-2.5 bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-xl text-sm text-secondary-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.stock && (
                    <p className="mt-1 text-xs text-danger-500">{errors.stock}</p>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="card rounded-xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  type="button"
                  onClick={addImage}
                  className="flex items-center gap-2 px-3 py-2 bg-theme-primary text-white rounded-lg hover:bg-theme-primary-dark transition-colors text-sm"
                >
            ...
            <div className="card rounded-xl p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 bg-surface-100 dark:bg-surface-800 text-secondary-900 dark:text-white rounded-lg hover:bg-surface-200 dark:hover:bg-surface-700 transition-colors text-sm"
                >
                  <Icon icon={Icons.plus} width={16} height={16} />
                ...
                {specifications.map((spec, index) => (
                  <div key={index} className="flex gap-3">
                    <input
                      ...
                      className="flex-1 px-4 py-2.5 bg-surface-50 dark:bg-surface-800 border border-surface-200 dark:border-surface-700 rounded-xl text-sm text-secondary-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-theme-primary/20 focus:border-theme-primary transition-all"
                    />
                    <input
                      type="text"
                      value={spec.value}
                    ...
                    <button
                      ...
                      className="p-2.5 text-danger-500 hover:bg-danger-50 dark:hover:bg-danger-900/20 rounded-lg transition-colors"
                    >
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="space-y-3">
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-theme-primary text-white rounded-lg hover:bg-theme-primary-dark transition-colors font-medium"
              >
              ...
              <Link
                ...
                className="block w-full text-center px-6 py-3 bg-surface-100 dark:bg-surface-800 text-secondary-900 dark:text-white rounded-lg hover:bg-surface-200 dark:hover:bg-surface-700 transition-colors font-medium"
              >
                {t('common.cancel')}
              </Link>
              {isEditMode && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-danger-500 text-white rounded-lg hover:bg-danger-600 transition-colors font-medium"
                >
