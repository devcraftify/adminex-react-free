...
export function VoiceCallPage() {
  ...
  return (
    <div className="h-[calc(100vh-7rem)] flex items-center justify-center bg-gradient-to-br from-surface-900 via-surface-800 to-surface-900 animate-fade-in rounded-2xl overflow-hidden">
