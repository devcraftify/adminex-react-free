  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-24 right-4 w-40 h-28 bg-surface-800 rounded-xl overflow-hidden ring-2 ring-white/10 shadow-xl">
        {isVideoOn ? (
          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-theme-primary/20 to-theme-primary/5">
            <img
      ...
      {/* Top Bar */}
      <div className={`absolute top-0 left-0 right-0 p-4 flex items-center justify-between bg-gradient-to-b from-black/50 to-transparent transition-opacity duration-300 ${showControls ? 'opacity-100' : 'opacity-0'}`}>
