        ...
        <div className="p-4 border-b border-surface-200 dark:border-surface-700">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-surface-100 dark:bg-surface-800 border-0 rounded-xl text-sm text-secondary-900 dark:text-white placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-theme-primary/20"
            />
          </div>
        </div>
            ...
            <div className="flex items-end gap-3">
              ...
              <div className="flex-1 relative">
                <textarea
                  ...
                  rows={1}
                  className="w-full px-4 py-3 bg-surface-100 dark:bg-surface-800 border-0 rounded-xl text-sm text-secondary-900 dark:text-white placeholder-secondary-400 focus:outline-none focus:ring-2 focus:ring-theme-primary/20 resize-none"
                  style={{ minHeight: '48px', maxHeight: '120px' }}
                />
                <button className="absolute right-3 top-1/2 -translate-y-1/2 p-1 hover:bg-surface-200 dark:hover:bg-surface-700 rounded-lg transition-colors">
              ...
              <button
                ...
                className="p-3 bg-theme-primary text-white rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
              >
