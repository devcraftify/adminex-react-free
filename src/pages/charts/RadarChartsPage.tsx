...
export function RadarChartsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="heading-2 text-secondary-900 dark:text-white">{t('charts.radar.title')}</h1>
        <p className="text-body-sm mt-1 text-secondary-500 dark:text-secondary-400">{t('charts.radar.subtitle')}</p>
      </div>

      <div className="card rounded-xl p-6">
        <h2 className="heading-5 text-secondary-900 dark:text-white">{t('charts.radar.comparison.title')}</h2>
        <p className="text-body-sm text-secondary-500 dark:text-secondary-400 mt-1">{t('charts.radar.comparison.desc')}</p>
        <div className="mt-4">
