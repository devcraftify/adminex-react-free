...
export default function FaqPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="card rounded-xl p-8 text-center bg-gradient-to-r from-theme-primary/10 to-theme-primary/5 dark:from-theme-primary/20 dark:to-theme-primary/10 border border-theme-primary/20">
        ...
        <button className="px-6 py-3 bg-theme-primary hover:bg-theme-primary-dark text-white rounded-xl text-base font-semibold transition-colors">
