  ...
  return (
    <div className="animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label 
              htmlFor="password" 
              className="block text-sm font-semibold text-secondary-900 dark:text-secondary-200"
            >
              {t('common.password')}
            </label>
            <Link 
        ...
        <div className="flex items-center">
          ...
          <label 
            htmlFor="remember" 
            className="ml-2 text-sm text-secondary-500 dark:text-secondary-400"
          >
      ...
      <div className="my-8 flex items-center gap-4">
        ...
        <span className="text-sm text-secondary-500 dark:text-secondary-400 font-medium">{t('auth.login.or_continue_with')}</span>
        <div className="h-px flex-1 bg-surface-200 dark:bg-surface-700" />
      </div>
